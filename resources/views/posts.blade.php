...
@section('container')
    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            @else
                <img src="https://source.unsplash.com/random/1200×200?{{ $posts[0]->category->name }}" class="card-img-top"
                ...
                @foreach ($posts->skip(1) as $post)
                    <div class="col-md-4 mb-2">
                        <div class="card">
                            ...
                            @else
                                <img src="https://source.unsplash.com/random/500×400?{{ $post->category->name }}"
